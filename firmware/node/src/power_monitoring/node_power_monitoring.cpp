...
float Node_PowerMonitoring::getSolarVoltage(){
    ...
    if(solar){
        ...
        #ifdef DEBUG
            log_msg("[DEBUG]: Solar: %f volts", solar_voltage);
        #endif
    } else {
        #ifdef DEBUG
...
float Node_PowerMonitoring::getBatteryVoltage(){
    ...
    if(battery){
        ...
        #ifdef DEBUG
            log_msg("[DEBUG]: Battery: %f volts", battery_voltage);
        #endif
    } else {
        #ifdef DEBUG
...
float Node_PowerMonitoring::getSolarCurrent(){
    ...
    if(solar){
        ...
        #ifdef DEBUG
            log_msg("[DEBUG]: Solar: %f milli-amps", solar_current);
        #endif
    } else {
        #ifdef DEBUG
...
float Node_PowerMonitoring::getBatteryCurrent(){
    ...
    if(battery){
        ...
        #ifdef DEBUG
            log_msg("[DEBUG]: Battery: %f milli-amps", battery_current);
        #endif
    } else {
        #ifdef DEBUG
